    ...
    return (
        <div className="col mb-5">
            <div className="card h-100 bg-secondary">
                <div className="badge bg-success text-white position-absolute" style={{ top: "0.5rem", right: "0.5rem" }}>{product.sale}</div>
                ...
                <div className="card-footer p-4 pt-0 border-top-0 bg-transperancy">
                    <div className="text-center">
